const en = {
  ...
  inventory_item_type_placeholder: "Select type",
  inventory_item_type_other: "Other",
  inventory_status_all: "All",
  inventory_status_in_stock: "In stock",
  inventory_status_in_stock_available: "In stock – no quotation",
  inventory_status_in_stock_claimed: "In stock – in confirmed quotation",
  inventory_status_sold: "Sold",
  inventory_status_returned: "Returned",
  inventory_total_purchase: "Total purchase",
  ...
  err_email_send_failed: "Failed to send email, please try again",
  ...
  quotations_filter_confirmed: "Confirmed",
  ...
  quotation_send_email: "Send mail",
  quotation_send_email_no_email: "Customer has no email; cannot send the quotation",
  quotation_send_email_confirm: "Send the quotation to {email}?",
  quotation_send_email_success: "Quotation emailed to the customer",
  ...
  settings_qr_upload: "Upload QR code",
  settings_qr_remove: "Remove QR code",
  settings_logo_too_large: "Image too large, please choose a file under 10MB",
  settings_initial_balance: "Initial balance (thousands VND)",
  settings_save: "Save settings",
  settings_saved: "Saved!",
  settings_section_shop: "Shop information",
